...
INSERT INTO brews.brew (id, recipe_id, brew_date, user_id) VALUES (2, 2, '2021-01-02', '1');

INSERT INTO brews.measurement (id, measurement_date, value, brew_id, version_id) VALUES (1, '2021-01-01', 1052.0, 1, 1);

SELECT setval(pg_get_serial_sequence('brews.measurement', 'id'), (SELECT MAX(id) FROM brews.measurement));
